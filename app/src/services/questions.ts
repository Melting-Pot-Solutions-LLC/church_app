...
export class QuestionsService {  
  ...
  getQuestionsByMonth(month: number)
  {
    return this.questions.filter(function(filteredElement) {
      return month == (new Date(filteredElement.date)).getUTCMonth();
    }).map(function(mappedElement) {
      return {
        'date': mappedElement.date,
        'date_month': (new Date(mappedElement.date)).toLocaleString('en-us', {
          month: "short",
          timeZone: 'UTC'
        }).toUpperCase(),
...
[
  {
    ...
    "date": "2017-01-05",
    "content": "<p>The app officially starts on January 21st, but go ahead and get in the habit of using the app by answering a few questions each day. </p><p>On each day of this series, content specific to that day will appear here on the app. Every day will have a unique journal entry paired with a church-wide challenge. We will do these daily challenges together, in order to cultivate spiritual health and walk in the vibrant, Godward, others-centered life God has called us to in Scripture. </p><p>Starting on January 21st, the progress bar at the top of your screen will keep up with your progress every time you click \"Save\" for a day's entry. The goal is that you will complete all 120 challenges.</p><p>In the meantime, you can find out more about this series and explore other resources at <a href=\"http://personalliturgy.com\">PersonalLiturgy.com</a>.</p>",
    "questions": [
      {
        "id": "",
        "title": "<p>How would you describe the year 2017 in your life?</p>",
        "type": "textarea"
      },
      {
        "id": "",
        "title": "<p>What were some of the best & worst things that happened in 2017? </p>",
        "type": "textarea"
      }
    ]
  },
  {
    ...
    "questions": [
      {
        "id": "",
        "title": "<p>Is there anything you regret or wish you would have done differently in 2017?</p>",
        "type": "textarea"
      },
      {
        "id": "",
        "title": "<p>Did you grow spiritually in 2017? If so, how? If not, why?</p>",
        "type": "textarea"
      }
    ]
  },
  {
    ...
    "questions": [
      {
        "id": "",
        "title": "<p>Do you have any goals for 2018?</p>",
        "type": "textarea"
      },
      {
        "id": "",
        "title": "<p>Did you make any resolutions? If so, how are you doing at sticking with them?</p>",
        "type": "textarea"
      }
    ]
  },
  {
    ...
    "questions": [
      {
        "id": "",
        "title": "<p>How would you like to grow spiritually in 2018?</p>",
        "type": "textarea"
      },
      {
        "id": "",
        "title": "<p>What’s your current plan for pursuing that growth? </p>",
        "type": "textarea"
      }
    ]
  },
  {
    ...
    "questions": [
      {
        "id": "",
        "title": "<p>Who has been the most positive role model in your life thus far?</p>",
        "type": "textarea"
      },
      {
        "id": "",
        "title": "<p>What have you learned from them? Have you expressed your gratitude for them recently?</p>",
        "type": "textarea"
      }
    ]
  },
  ...
  },
  {
    ...
    "questions": [
      ...
      {
        "id": "",
        "title": "<p>What’s going well in your life right now?</p>",
        "type": "textarea"
      }
    ]
  },
  {
    ...
    "questions": [
      ...
      {
        "id": "",
        "title": "<p>What is your current pattern of exercise, and are you happy with it?</p>",
        "type": "textarea"
      }
    ]
  },
